...
<script src="{{asset('user/js/jquery-2.2.3.min.js')}}"></script>
		...
		<!-- credit-card -->
		<script type="text/javascript" src="{{asset('user/js/creditly.js')}}"></script>
		<link rel="stylesheet" href="{{asset('user/css/creditly.css')}}" type="text/css" media="all" />
								...
								<div class="tab4">
									<div class="pay_info row">
										<div class="col-md-6 tab-grid">
											<img class="pp-img" src="{{asset('user/images/paypal.png')}}" alt="Image Alternative text" title="Image Title">
