      ...
      <div class="col-12">
        ...
        <div class="card">
          <div class="card-header">
           <table>
            <tr>
              <td width="90%"><h3 class="card-title">Product</h3></td>
              <td width=""></td>        
              ...
              <tbody>
               @foreach($data1 as $DATA1)
                <tr>
                    ...
                    <a onclick="return deletehay()" href="{{route('admin.garbage.product.fix',['id'=>$DATA1->id_product])}}"><span class="badge bg-danger">Restore</span></a>
