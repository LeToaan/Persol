...
<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700&display=fallback">
  ...
  <script>
  function deletehay(){
    if(window.confirm('Are you sure you want to restore')== true ){
        return true;
    }
    return false;
}
              ...
              <tbody>
               @foreach($data1 as $DATA1)
                <tr>
                    ...
                    <a onclick="return deletehay()" href="{{route('admin.garbage.member.restore',['id'=>$DATA1->id])}}"><span class="badge bg-danger">restore</span></a>
                    ...
                    <td>@if($DATA1->gender_account==0) Male @elseif ($DATA1->gender_account==1) Female @else Other @endif </td>
