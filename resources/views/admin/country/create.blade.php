...
@endif
    <form method="post" action="{{ route('admin.country.store') }}" enctype="multipart/form-data" id="form-1">
        @csrf
            ...
            <div class="card-body">
                <div class="form-group  ">
                    ...
                    <div class="input-group date" id="reservationdate" data-target-input="nearest">
                        <input type="text" placeholder="Country Name" name="name_country" value="{{ old('name_country') }}"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            Validator({
                ...
                rules: [
                     Validator.isRequired('#name', 'Plese Enter Country Name'),
