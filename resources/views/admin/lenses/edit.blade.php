...
@section('body1')
    ...
    @endif
    <form method="post" action="{{ route('admin.product.lenses.update',['id'=>$product->id_product]) }}" enctype="multipart/form-data" id="form-1">
        @csrf
        <div class="card card-primary">
            ...
            <div class="card-body" id='cardBody'>
                ...
                <div class="form-group  ">
                    <label>Extract:</label>
                    <div class="input-group date" id="reservationdate" data-target-input="nearest">
                        <input type="text" name="extract" value="{{ $properties->extract }}" class="form-control datetimepicker-input  " data-target="#reservationdate" id="extract">
                ...
                <div class="form-group  ">
                    <label>Coating:</label>
                    <div class="input-group date" id="reservationdate" data-target-input="nearest">
                        <input type="text" name="coating" value="{{$properties->coating }}" class="form-control datetimepicker-input  " data-target="#reservationdate" id="coating">
                ...
                <div class="form-group  ">
                    <label>Special:</label>
                    <div class="input-group date" id="reservationdate" data-target-input="nearest">
                        <input type="text" name="special" value="{{ $properties->special }}" class="form-control datetimepicker-input  " data-target="#reservationdate" id="special">
            ...
            <div class="card-footer">
                ...
                <span class="input-group-text" onclick="met({{$vitri}})" >Fix</span>
                <br>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            Validator({
                ...
                rules: [
                    Validator.isRequired('#name', 'Pleses Enter Name Product'),
                    ...
                    Validator.isRequired('#material', 'Please enter material'),
                    Validator.isRequired('#coating', 'Please enter coating'),
                    Validator.isRequired('#special', 'Please enter special'),
                    Validator.isRequired('#extract', 'Please enter extract'),
