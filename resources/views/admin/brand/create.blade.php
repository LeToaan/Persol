...
@endif
    <form method="post" action="{{ route('admin.brand.store') }}" enctype="multipart/form-data" id="form-1">
        @csrf
            ...
            <div class="card-body">
                <div class="form-group  ">
                    ...
                    <div class="input-group date" id="reservationdate" data-target-input="nearest">
                        <input type="text" placeholder="Brand Name" name="name_brand" value="{{ old('name_brand') }}"
                ...
                <div class="form-group  ">
                    ...
                    <div class="input-group date" id="reservationdate" data-target-input="nearest">
                        <textarea type="text" name="intro_brand"
                            ...
                            id="intro">{{ old('intro_brand') }}</textarea >
                    </div>
                ...
                <div class="form-group ">
                    ...
                    <div class="input-group date" id="reservationdate" data-target-input="nearest">
                       ...
                       <option value="frame" @if (old('category_brand') == 'frame' ) selected @endif>Frame</option>
                       <option value="lenses"  @if (old('category_brand') == 'lenses' ) selected @endif>Lenses</option>
                        </select>
                    </div>
