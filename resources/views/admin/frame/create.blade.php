...
@section('body1')
    ...
    @endif
    <form method="post" action="{{ route('admin.product.frame.store') }}" enctype="multipart/form-data" id="form-1">
        @csrf
        <div class="card card-primary">
            ...
            <div class="card-body" id='cardBody'>
                ...
                <div class="form-group  ">
                    <label>Price:</label>
                    <div class="input-group date" id="reservationdate" data-target-input="nearest">
                        <input type="text" placeholder="Price" name="price_product" value="{{ old('price_product') }}"
                ...
                <div class="form-group  ">
                    <label>Nose Pads:</label>
                    <div class="input-group date" id="reservationdate" data-target-input="nearest">
                        <input type="text" name="nose_pads" value="{{ old('nose_pads') }}"
                            class="form-control datetimepicker-input  " data-target="#reservationdate" id="nose_pads">
                ...
                <div class="form-group  ">
                    ...
                    <div class="input-group date" id="reservationdate" data-target-input="nearest">
                        <input type="text" name="size" value="{{ old('size') }}"
                            class="form-control datetimepicker-input  " data-target="#reservationdate" id="size">
            ...
            <div class="card-footer">
                ...
                <span class="input-group-text" onclick="hayqua()">-------------------------------------</span>
            </div>
            <table>
                <tr>
